...
bakendoApp.controller('MainController', function ($scope) {
    });

bakendoApp.controller('AdminController', function ($scope) {
    });

bakendoApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
bakendoApp.controller('MenuController', function ($scope) {
    });

bakendoApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
bakendoApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

bakendoApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
bakendoApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
bakendoApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
bakendoApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
bakendoApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 bakendoApp.controller('TrackerController', function ($scope) {
...
bakendoApp.controller('HealthController', function ($scope, HealthCheckService) {
...
bakendoApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
bakendoApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
bakendoApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
