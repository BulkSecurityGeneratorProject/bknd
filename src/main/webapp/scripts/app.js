...
var bakendoApp = angular.module('bakendoApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'bakendoAppUtils', 'pascalprecht.translate', 'truncate']);
