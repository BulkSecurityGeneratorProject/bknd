package com.bakendo.app.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import com.bakendo.app.web.filter.CachingHttpHeadersFilter;
import com.bakendo.app.web.filter.StaticResourcesProductionFilter;
import com.bakendo.app.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "com.bakendo.app.web.websocket");
