...
@Configuration
@EnableJpaRepositories("com.bakendo.app.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.bakendo.app.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.bakendo.app.domain");
        return basePackages;
    }
